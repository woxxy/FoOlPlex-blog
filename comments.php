...
<?php if (comments_open()) : ?>
	...
	<section id="respond">
		...
		<h3><?php comment_form_title('Leave an Opinion', 'Leave an opinion for %s'); ?></h3>
		...
		<?php else : ?>
			...
			<form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
				...
				echo "aria-required='true'"; ?> />
					...
					<p>
						<input type="email" name="email" id="email" value="<?php echo esc_attr($comment_author_email); ?>" size="22" tabindex="2" <?php if ($req)
					echo "aria-required='true'"; ?> />
				...
				<p>
					<input name="submit" type="submit" id="submit" tabindex="5" value="Submit Opinion" />
